...
left-ey = cv2.CascadeClassifier('haar-cascade-files\haarcascade_lefteye_2splits.xml')
right-ey = cv2.CascadeClassifier('haar-cascade-files\haarcascade_righteye_2splits.xml')
...
while(True):
  ...
  left_eye_gray = right-ey.detectMultiScale(gray)
  right_eye_gray = left-ey.detectMultiScale(gray)
